import './right.css'
import {Checkbox, Row, Col, Card, ConfigProvider, Form, Input, Space, TreeSelect, Button, Modal, Table, DatePicker} from 'antd';
...
import DemoLiquid from "./DemoGauge";
moment.locale('zh-cn');
...
function MenuRight(props) {
    ...
    return (
        <div className={'middle_right'}>
            <div style={{width: '370px', height: '300px', marginBottom: '20px',backgroundColor:'#fff'}}>
