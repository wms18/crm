...
function Task(props) {
  ...
  for (let i = 0; i < taskAllLabel.length; i++) {
    children.push(
      <Option key={taskAllLabel[i].id}>{taskAllLabel[i].labelName}</Option>
    );
  }
  //添加标签
  ...
  const contentLabel = (
    <div style={{ width: "300px", height: "200px" }}>
      ...
      <Popover
        ...
        trigger="click"
      >
        <Button style={{ position: "absolute", left: "10px", bottom: "10px" }}>
          新增标签
        </Button>
      </Popover>
      <Popover
  ...
  const contentMan = (
    <div style={{ width: "400px", height: "300px" }}>
      ...
      >
        ...
        <Button onClick={hide} style={{ marginLeft: "30px" }}>
          取消
        </Button>
      </div>
    </div>
          ...
          <div>
            {taskList.map((item, index) => {
              ...
              return (
                ...
                >
                  <Checkbox disabled={true} onChange={onChangeCheckbox}>
                    {item.taskName}
                  </Checkbox>
                ...
                <div className={"taskAddLabel"}>
                  <div>
                    {taskAllLabelName.map((item, index) => {
                      return (
                        <span
                          className={item === "" ? "hidden" : "taskLabelName"}
                          key={index}
                        >
                          <Popconfirm
                            title="确定删除吗?"
                  ...
                  <div>
                    ...
                    <Popover content={contentDate} title="" trigger="click">
                      <span>
                        <i
                          style={{ color: "#a6a6e6", cursor: "pointer" }}
                  ...
                  <div style={{ margin: "20px 0" }}>
                    <span style={{ marginRight: "20px" }}>
                      <img
                        ...
                        src={personInformation.avatar}
                        alt=""
                      />
                    </span>
                    <span onClick={taskAddComment} className={"taskAddComment"}>
                      添加评论
                    </span>
                  </div>
